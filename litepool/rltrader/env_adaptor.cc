...
void EnvAdaptor::quote(const double& bid_spread, const double& ask_spread, const double& bid_size, const double& ask_size, const double& target) {
    this->strategy.quote(bid_spread, ask_spread, bid_size, ask_size, target, bid_prices, ask_prices);
}
