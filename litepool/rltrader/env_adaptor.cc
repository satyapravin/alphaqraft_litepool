...
void EnvAdaptor::quote(const double& bid_spread, const double& ask_spread, const double& quote_range) {
    this->strategy.quote(bid_spread, ask_spread, quote_range, bid_prices, ask_prices);
}
