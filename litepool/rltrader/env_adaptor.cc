...
void EnvAdaptor::quote(const double& bid_spread, const double& ask_spread, const double& target_q) {
    this->strategy.quote(bid_spread, ask_spread, target_q, bid_prices, ask_prices);
}
